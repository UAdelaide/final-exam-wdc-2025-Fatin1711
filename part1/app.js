  ...
  try {
    ...
    if (users[0].count === 0) {
      ...
      await db.execute(`
        ...
        (2, (SELECT user_id FROM Users WHERE username = 'carol123'), (SELECT user_id FROM Users WHERE username = 'carol123'), 5, 'Great job!'),
        (3, (SELECT user_id FROM Users WHERE username = 'carol123'), 5, 'Great job!'),
      `);
    }
  } catch (err) {
